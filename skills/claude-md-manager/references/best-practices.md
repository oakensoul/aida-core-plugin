...
description: >-
  Guidelines for creating effective CLAUDE.md files
version: 0.1.0
---
...
CLAUDE.md files that help Claude Code understand and work
with your project.

## Purpose

CLAUDE.md files provide project-specific guidance to
Claude Code. They should:

- Help Claude understand the project's purpose and
  structure
...
1. **Project Overview** - Brief description of what the
   project does
2. **Key Commands** - Most commonly used commands (build,
   test, run)

### Recommended Sections

1. **Architecture** - High-level structure and key
   components
2. **Coding Conventions** - Style guide, patterns to
   follow
3. **Important Constraints** - Things Claude should
   always consider

### Optional Sections

1. **Testing Guidelines** - How to run tests, coverage
   expectations
...
Longer files should be split into sections that can be
loaded on demand.
...
```markdown
## Overview
REST API for inventory management built with FastAPI
and PostgreSQL. Handles ~50k requests/day with
...
```markdown
## Commands
npm run dev  # This was renamed months ago
```
...
description: Claude Code configuration for this repo
---
